    ...
    public class FileSystemProcessor : IFileProcessor
    {
        ...
        public string OutputPath
        {
            ...
            set
            {
               ...
               if ( !value.Contains( ":" ) ) value =  System.Web.HttpContext.Current.Server.MapPath( value );
        ...
        public object StartNewFile(string fileName, string contentType, Dictionary<string, string> headerItems, Dictionary<string, string> previousFields)
        {
            ...
            {
                _fileName = fileName;
                _localFileName = Path.GetFileName( fileName ) + "." + Guid.NewGuid().ToString().ToUpper().Replace( "-", "" );
                _fullFileName = _outputPath + _localFileName;
        ...
        /// <summary>
        /// Returns the local name of the file that is currently being processed.
        /// Null if there is no file.
        /// </summary>
        /// <returns>The file name.</returns>
        ...
        /// <summary>
        /// Returns the full local path to the file that is currently being processed.
        /// Null if there is no file.
        /// </summary>
        /// <returns>The file name.</returns>
