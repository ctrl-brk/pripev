...
namespace darrenjohnstone.net.FileUpload
{
    ...
    public class UploadedFile
    {
        ...
        string _fileName, _localFileName, _localFullFileName;
        object _identifier;
        ...
        /// <summary>
        /// Gets the local file name without path.
        /// </summary>
        ...
        public UploadedFile(string fileName, object identifier, Dictionary<string, string> headerItems, string localFileName, string localFullFileName )
        {
            _fileName = fileName;
            _localFileName = localFileName;
            _localFullFileName = localFullFileName;
        ...
        public UploadedFile(string fileName, object identifier, Dictionary<string, string> headerItems, string localFileName, string localFullFileName, Exception ex) : this(fileName, identifier, headerItems, localFileName, localFullFileName)
        {
            _exception = ex;
        }
