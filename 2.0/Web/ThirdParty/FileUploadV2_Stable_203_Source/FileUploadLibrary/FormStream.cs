...
namespace darrenjohnstone.net.FileUpload
{
    ...
    /// </param>
    public delegate void FileEventHandler(object sender, string fileName, string localFileName, string localFullFileName, object identifier);
    ...
    public delegate void FileErrorEventHandler( object sender, string fileName, string localFileName, string localFullFileName, object identifier, Exception ex );
    ...
    class FormStream : Stream, IDisposable
    {
        ...
        {
            if (FileStarted != null)
                FileStarted(this, fileName, null, null, identifier);
        }
        ...
        protected void OnFileCompleted(string fileName, object identifier)
        {
            if (FileCompleted != null)
                FileCompleted(this, fileName, Processor.GetLocalFileName(), Processor.GetLocalFullFileName(), identifier);
        }
        ...
        protected void OnFileCompletedError(string fileName, object identifier, Exception ex)
        {
            if (FileCompletedError != null)
               FileCompletedError( this, fileName, Processor.GetLocalFileName(), Processor.GetLocalFullFileName(), identifier, ex );
        }
