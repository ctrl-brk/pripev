...
namespace darrenjohnstone.net.FileUpload
{
    ...
    public class DJUploadController : WebControl
    {
        ...
        string DEFAULT_IMAGE_PATH = "/Upload/Images";
        string DEFAULT_CSS_PATH = "/Upload/Styles";
        string DEFAULT_JS_PATH = "/Upload/Scripts";
            ...
            foreach (Control c in cc)
            {
                ...
                if (fu != null && fu.HasFile)
                {
                    ...
                    try
                    {
                        ...
                        status.UploadedFiles.Add(new UploadedFile(fu.FileName, processor.GetIdentifier(), null, processor.GetLocalFileName(), processor.GetLocalFullFileName() ));
                    }
                    catch(Exception ex)
                    {
                        status.ErrorFiles.Add(new UploadedFile(fu.FileName, processor.GetIdentifier(), null, processor.GetLocalFileName(), processor.GetLocalFullFileName(), ex));
                    }
                }
