...
namespace darrenjohnstone.net.FileUpload
{
    ...
    public class UploadModule : IHttpModule
    {
        ...
        void fs_FileStarted(object sender, string fileName, string localFileName, string localFullFileName, object identifier)
        {
        ...
        void fs_FileCompletedError( object sender, string fileName, string localFileName, string localFullFileName, object identifier, Exception ex )
        {
            _status.ErrorFiles.Add(new UploadedFile(fileName, identifier, null, localFileName, localFullFileName, ex));
        }
        ...
        /// <param name="fileName">File name</param>
        /// <param name="identifier">Container identifier.</param>
        void fs_FileCompleted( object sender, string fileName, string localFileName, string localFullFileName, object identifier )
        {
            _status.UploadedFiles.Add(new UploadedFile(fileName, identifier, null, localFileName, localFullFileName));
        }
        ...
        HttpWorkerRequest GetWorkerRequest(HttpContext context)
        {
            ...
            //TODO: Commented next line to work in .net 4.0. Need to figure out why
