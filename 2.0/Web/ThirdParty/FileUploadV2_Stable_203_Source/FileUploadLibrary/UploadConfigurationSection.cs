...
namespace darrenjohnstone.net.FileUpload
{
    ...
    public sealed class UploadConfigurationSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty("scriptPath", DefaultValue = "/Upload/Scripts", IsRequired = false)]
        ...
        [ConfigurationProperty("cssPath", DefaultValue = "/Upload/Styles", IsRequired = false)]
        ...
        /// </summary>
        /// <value>The image path.</value>
        [ConfigurationProperty("imagePath", DefaultValue = "/Upload/Images", IsRequired = false)]
