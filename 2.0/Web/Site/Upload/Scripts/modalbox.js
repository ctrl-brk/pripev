...
Modalbox.Methods = {
	...
	active: true,
	options: {
		title: "Диалог", // Title of the ModalBox window
		...
		loadingString: "Подождите...", // Default loading string message
		closeString: "Закрыть окно", // Default title attribute for close window link
	...
	hide: function(options) { // External hide method to use from external HTML and JS
		...
		} else throw("Диалог не инициализирован.");
	},
	...
	loadContent: function () {
		if(this.event("beforeLoad") != false) { // If callback passed false, skip loading of the content
			if(typeof this.content == 'string') {
				...
				Modalbox.hide();
				throw('Ошибка в параметрах диалога: Укажите корректный URL или HTML элемент (HTML или object)');
			}
		}
	},
