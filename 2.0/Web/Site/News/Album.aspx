<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Album.aspx.cs" Inherits="Pripev.Web.UI.News.Albums" MasterPageFile="~/Main.Master" %>
...
<asp:Repeater ID='rptNews' runat='server'>
   ...
   <ItemTemplate>
      <tr>
         <td class='name' nowrap><asp:HyperLink ID='lnkAlbum' runat='server' NavigateUrl='<%# "/Album.aspx?Id=" + Eval( "ALBUM_ID" ) %>' Text='<%# Eval( "AlbumName" ) %>' /></td>
